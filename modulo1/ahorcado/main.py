...
palabras = '''valoracion aprenderpython comida juego python web imposible
            variable
            curso volador cabeza reproductor mirada escritor billete lapicero
            celular valor revista gratuito disco voleibol
...
def elijeLetra(algunaLetra):
    ...
    # Esta función hace que el jugador ingrese una letra
